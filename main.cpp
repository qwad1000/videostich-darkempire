...
int main(void) {
    ...
    while(true) {
         ...
         */
        int convert_flag = 0; //CV_CVTIMG_FLIP;
        cvConvertImage(frame, frame1_1C, convert_flag);

        /* We'll make a full color backup of this frame so that we can draw on it.
         * (It's not the best idea to draw on the static memory space of cvQueryFrame().)
         */
        allocateOnDemand( &frame1, frame_size, IPL_DEPTH_8U, 3 );
        cvConvertImage(frame, frame1, convert_flag);
        ...
        cvConvertImage(frame, frame2_1C, convert_flag);
        ...
        CvPoint2D32f frame1_features[number_of_features_desired];
         ...
         */
        int number_of_features = number_of_features_desired;
        ...
        CvPoint2D32f frame2_features[number_of_features_desired];

        /* The i-th element of this array will be non-zero if and only if the i-th feature of
         * frame 1 was found in frame 2.
         */
        char optical_flow_found_feature[number_of_features_desired];

        /* The i-th element of this array is the error in the optical flow for the i-th feature
         * of frame1 as found in frame 2.  If the i-th feature was not found (see the array above)
         * I think the i-th entry in this array is undefined.
         */
        float optical_flow_feature_error[number_of_features_desired];
        ...
        for(int i = 0; i < number_of_features; i++) {
            ...
            draw_arrow(frame1, frame1_features, frame2_features, i);
...
void draw_arrow(IplImage *frame1, CvPoint2D32f *frame1_features, CvPoint2D32f *frame2_features, int i) {
    ...
    double hypotenuse = hypot(p.y - q.y, p.x - q.x);
